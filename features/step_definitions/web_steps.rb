...
Given /^the website is set up$/ do
  User.create!({:username => 'test_user', :password => 'password',
                ...
                :email => 'xxx@xxx.com', :phone => '4807889687',
                :address => 'nothing where I live'}
              )
  ...
  User.create!({:username => 'test_user2', :password => 'password',
                :admin => '0', :cowboy => '0', :handy => '1', :doctor => '0',
                :first_name => 'Test', :last_name => 'User2',
                :email => 'cdaigle@tamu.edu', :phone => '9798629171',
                :address => 'Department of Animal Science'}
              )
  User.create!({:username => 'test_user3', :password => 'password',
                :admin => '0', :cowboy => '0', :handy => '0', :doctor => '1',
                :first_name => 'Test', :last_name => 'User3',
                :email => 'cdaigle@tamu.edu', :phone => '9798629171',
                :address => 'Department of Animal Science'}
              )
  Pen.create!({:num => '1', :total_num => '100'})
...
And /^I am logged in as the adminitrator$/ do
  visit '/login'
...
And /^I am logged in as the technician$/ do
  visit '/login'
